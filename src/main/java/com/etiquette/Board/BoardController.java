...
public class BoardController {
  ...
  public BoardController(JwtService jwtService) {
        this.jwtService = jwtService;
  }

  @PostMapping(path="/add") // Map ONLY POST Requests
  public @ResponseBody ResponseEntity<?> addNewBoard (@RequestBody AddBoardFormDto addBoardFormDto, @CookieValue(name = "jwt-token") String token) {
    ...
    // @RequestParam means it is a parameter from the GET or POST request
      ...
      addBoardFormDto.setUserOwner(addUserDto);
